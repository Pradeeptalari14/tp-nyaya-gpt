# 📖 nyaya-gpt (Constitution & BNS)

> ReAct-based agent processing Bharatiya Nyaya Sanhita (BNS) queries. Connects to Slack alerting channels.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/nyaya-gpt/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-nyaya-gpt.git
cd tp-nyaya-gpt
```
...
```bash
kubectl port-forward deployment/tp-nyaya-gpt 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── nyaya_gpt.py     # Main configuration file
```
...
---
*Generated by [nyaya-gpt (Constitution & BNS) Studio](https://pradeeptalari14.github.io/portfolio/tools/nyaya-gpt/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
